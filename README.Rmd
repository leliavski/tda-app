...
To better understand the topological terminology (k-skeleton, nerve, Cech complex, VR complex), you can use a little interactive tool, [the Simplicial Complex Explorer](simplicial_complex_explorer.html).
